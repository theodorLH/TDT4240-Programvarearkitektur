package com.mads.tdt4240.game.sprites;
...
public class Paddle {
    ...
    public void update(float dt){
        if(position.y < 0) {
            position.y = 0 ;
        } else if (position.y + paddle.getHeight() > Game.HEIGHT) {
            position.y = Game.HEIGHT - paddle.getHeight();
        } else {
