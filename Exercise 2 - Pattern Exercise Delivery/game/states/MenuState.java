...
public class MenuState extends State {
    ...
    public MenuState(GameStateManagerSingleton gsm){
        ...
        task1_3.setPosition(Game.WIDTH / 2 - task1_3.getTexture().getWidth() /2, Game.HEIGHT - (3/2)* task1_3.getTexture().getHeight());
        task2.setPosition(Game.WIDTH / 2 - task2.getTexture().getWidth() /2, Game.HEIGHT / 2 - task2.getTexture().getHeight()/2);
        task4.setPosition(Game.WIDTH / 2 - task4.getTexture().getWidth() /2, task4.getTexture().getHeight()/3);
    }
    ...
    public void handleInput() {
        ...
        if(Gdx.input.justTouched()) {
            ...
            if(task4.getBounds().contains(touchPosition.x, touchPosition.y)){
                Paddle paddleL = new Paddle(0 , Game.HEIGHT/2 + 50);
                Paddle paddleR = new Paddle(Game.WIDTH-paddleL.getTexture().getWidth(), Game.HEIGHT/2 + 50);
